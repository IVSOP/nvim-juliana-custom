...
return function(colors, highlight)
    ...
    highlight('Function', text_magenta)
    ...
    highlight('@function.builtin', { fg = C.blue2})
    ...
    highlight('@keyword.function', text_magenta)
    highlight('@keyword.function.python', { fg = C.red2})
    ...
    highlight('@number', { fg = C.yellow2 }) -- { fg = C.yellow1 })
    highlight('@number.bash', { fg = C.yellow2 })
    highlight('Number', { fg = C.yellow2 })
    highlight('@operator', text_orange)
    ...
    highlight('@variable.builtin', { fg = C.fg2})
    highlight('@variable.builtin.clojure', { fg = C.fg2})
    highlight('@variable.builtin.javascript', { fg = C.fg2})
    highlight('gitCommitSelectedFile', { })
    highlight('gitCommitSummary', { bold = true })
    highlight('gitCommitTrailerToken', text_magenta)
    ...
    highlight('tmuxCommands', text_magenta)
    ...
    highlight('FennelSpecialForm', text_magenta)
    ...
    highlight('helpCommand', { bg = C.bg1})
    ...
    highlight('CmpItemKindKeyword', text_magenta)
    ...
    highlight('@lsp.typemod.type.defaultLibrary', { fg = C.blue2})
    highlight('@lsp.typemod.type.documentation', text_yellow)
    highlight('@lsp.type.enum', text_yellow)
    highlight('@lsp.typemod.enum.defaultLibrary', { fg = C.blue2})
    highlight('@lsp.type.interface', text_yellow)
    highlight('@lsp.typemod.interface.defaultLibrary', { fg = C.blue2})
    highlight('@lsp.type.class', text_yellow)
    highlight('@lsp.typemod.class.defaultLibrary', text_yellow)
    highlight('@lsp.type.struct', { fg = C.yellow2 })
    highlight('@lsp.typemod.struct.defaultLibrary', { fg = C.blue2})
    ...
    highlight('@lsp.typemod.function.defaultLibrary', { })
    ...
    highlight('@lsp.typemod.decorator.defaultLibrary', { fg = C.cyan2, bold = true})
    highlight('@lsp.type.namespace', { fg = C.yellow2 })
    highlight('@lsp.typemod.namespace.defaultLibrary', { fg = C.yellow2})
    ...
    highlight('@lsp.mod.defaultLibrary', { })
    highlight('@lsp.mod.deprecated', { strikethrough = true })
    highlight('@lsp.mod.declaration', {})
    highlight('@lsp.typemod.variable.global.lua', { fg = C.fg1})
    ...
    highlight('CocSemKeyword', { })
    highlight('CocSemComment', { fg = 'NONE' })
    highlight('CocSemReadonlyVariable', { })
    highlight('CocSemStaticVariable', { })
    ...
    highlight('@lsp.type.macro', text_cyan)
    highlight('@keyword.cpp', text_red)
    highlight('@keyword.modifier.cpp', text_red)
    highlight('@type.builtin.cpp', text_magenta)
    highlight('@lsp.type.property.cpp', { fg = C.fg2 })
    highlight('@lsp.typemod.type.defaultLibrary.cpp', { link = '@type.cpp' })
